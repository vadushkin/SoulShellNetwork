...
class NewsModelsTest(TestCase):
    def setUp(self):
        ...
        self.first_news = News.objects.create(
            user=self.user, content="This is the first"
        )
        self.second_news = News.objects.create(
            user=self.user, content="This is the second"
        )
        self.third_news = News.objects.create(
            user=self.other_user,
            content="This is an answer to the first",
            reply=True,
    ...
    def test_reply_this(self):
        ...
        self.first_news.reply_this(self.other_user, "This is an answer to the second")
