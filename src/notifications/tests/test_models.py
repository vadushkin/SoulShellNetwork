...
from src.notifications.models import Notification, notification_handler
...
class NotificationsModelsTest(TestCase):
    ...
    def test_return_values(self):
        ...
        assert str(self.first_notification).replace(" ", " ") == "test_user liked 0 minutes ago"
        assert str(self.second_notification).replace(" ", " ") == "test_user commented 0 minutes ago"
        assert str(self.third_notification).replace(" ", " ") == "other_test_user answered 0 minutes ago"

        test_case = str(self.fourth_notification).replace(" ", " ")
        assert test_case == "other_test_user answered This is a short content. 0 minutes ago"
